...
// Register Custom Post Type
function weddings_events() {

	$labels = array(
		'name'                  => _x( 'weddings_events', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'wedding_event', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Weddings & Events', 'text_domain' ),
		...
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Add New Wedding/Event', 'text_domain' ),
		'new_item'              => __( 'New Wedding/Event', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
		'view_item'             => __( 'View Item', 'text_domain' ),
		'view_items'            => __( 'View Items', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'wedding_event', 'text_domain' ),
		'description'           => __( 'weddings and events', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array(),
		'hierarchical'          => false,
	...
	register_post_type( 'weddings_events', $args );

}
add_action( 'init', 'weddings_events', 0 );
...
function gardens() {
	...
	$labels = array(
		'name'                  => _x( 'gardens', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'garden', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Gardens', 'text_domain' ),
		'name_admin_bar'        => __( 'Gardens', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Add New Garden', 'text_domain' ),
		'new_item'              => __( 'New Garden', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
		'view_item'             => __( 'View Item', 'text_domain' ),
		'view_items'            => __( 'View Items', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'garden', 'text_domain' ),
		'description'           => __( 'gardens', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array(),
		'hierarchical'          => false,
...
// Register Custom Taxonomy Garden Types - dish and vertical
function garden_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Garden Types', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Garden Type', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Garden Types', 'text_domain' ),
		'all_items'                  => __( 'All Garden Types', 'text_domain' ),
		'parent_item'                => __( 'Parent Item', 'text_domain' ),
		'parent_item_colon'          => __( 'Parent Item:', 'text_domain' ),
		'new_item_name'              => __( 'New Garden Type', 'text_domain' ),
		'add_new_item'               => __( 'Add New Garden Type', 'text_domain' ),
		'edit_item'                  => __( 'Edit Item', 'text_domain' ),
		'update_item'                => __( 'Update Item', 'text_domain' ),
		'view_item'                  => __( 'View Item', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separate items with commas', 'text_domain' ),
	...
	register_taxonomy( 'types', array( 'gardens' ), $args );

}
add_action( 'init', 'garden_taxonomy', 0 );